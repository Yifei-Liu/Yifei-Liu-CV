...
% 08/02/2024 prevent page breaks immediately after section headings
\usepackage{needspace}

% Geometry package for page margins.
% 05/27/2021 Set 1 inch margins for 4 sides
\usepackage[
%left=1.0in,
%right=1.0in,
%top=1.0in,
...
% for Github and LinkedIn icons/logos
\usepackage{fontawesome5}

% PDF settings and properties.
\usepackage{apacite}
% moderncv loads the package hyperref by itself with its own hypersetup. From moderncv.cls
...
% Math black square/black circle
\usepackage{amsmath}%
\usepackage{MnSymbol}%
\usepackage{wasysym}%
...
% Next setmainfont line: 2023/08/13 For Mário Portuguese name

% \homepage
% \usepackage{moderncv}

% 2024/04/02 Fix Font shape `U/wasy/m/n' in size <10.5> not available warnings
...
% Use Native TimesNewRoman instead 08/13/2023 to support Mário Portuguese name
\setmainfont{Times New Roman}

% Use TimesNewRoman instead 05/26/2021 (Note 08/13/2023 this cannot support Portuguese characters)
%\setmainfont
...
% Change From rmfamly to sffamily 05/27/2021
\renewcommand{\sffamily}{\sffamily}
...
\newcommand{\UseNoteFont}{\UseHeadingFont\fontsize{10pt}{12pt}\selectfont}
...
\newcommand{\UseSectionFont}{\UseHeadingFont\fontsize{12.5pt}{15pt}\selectfont\bfseries}
\newcommand{\UseSubSectionFont}{\UseHeadingFont\fontsize{10pt}{12pt}\selectfont\bfseries}
\newcommand{\UseDetailFont}{\normalfont\fontsize{10pt}{12pt}\selectfont}

% Symbols (unicode).
\newcommand{\BulletSymbol}{{\normalfont\fontsize{10.5}{12.6}\selectfont\raisebox{0.17em}{$\bullet$}}}
\newcommand{\SubBulletSymbol}{{\normalfont\fontsize{10}{12}\selectfont\raisebox{0.17em}{$\mhyphen$}}}
...
% 08/02/2024: New section marco with needspace
% \needspace{4\baselineskip} ensures that at least four lines of text can fit on the current page after the section heading. If this space is not available, the section will automatically start on a new page.

% \renewcommand{\section}[3]{%
%     \\[-1em]\pdfbookmark[2]{#2}{#3}\\%
%     {\UseSectionFont\raggedright{#1}}%
%     \needspace{4\baselineskip} % Ensure at least 4 lines fit on the page
%     &%
% }
...
% {\UseSubSectionFont\raggedright{#1}}%
% \vspace{0.225\baselineskip}}

\renewcommand{\subsection}[3]{
\par~\vskip-\baselineskip%
%\vspace{0.05\baselineskip}% Reduced vertical space before subsection, prev 0.225
\pdfbookmark[3]{#2}{#3}\par%
{\UseSubSectionFont\raggedright{#1}}
}%
%\vspace{0.05\baselineskip}}% Reduced vertical space after subsection, prev 0.225

% 08/02/2024: subsection macro with needspace
% \renewcommand{\subsection}[3]{%
%     \needspace{3\baselineskip} % Adjust this value based on how much space you want to ensure
%     \par~\vskip-\baselineskip%
%     \vspace{0.225\baselineskip}%
%     \pdfbookmark[3]{#2}{#3}\par%
%     {\UseSubSectionFont\raggedright{#1}}%
