...
\NumberedItem{[1]}
K. Zhou, Y. Liu, Y. Yang, H. Wang, C. Li, Y. Wang, \textbf{\textit{Y. Liu}}. Method for valuation of image dark data based on similarity hashing. U.S. Patent US11,138,479B2, Granted: 10/05/2021. % Filed: 07/30/2019. 

\Gap

\NumberedItem{[2]}
K. Zhou, \textbf{\textit{Y. Liu}}, Y. Liu, Y. Wang, Y. Yang. Image query method and system based on content semantic metadata. Chinese Patent CN110413807B, Granted: 04/20/2021. % Filed: 06/24/2019.
